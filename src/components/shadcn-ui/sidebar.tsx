...
>(
  (
    { side = 'start', variant = 'sidebar', collapsible = 'offcanvas', className, style: _style, children, ...props },
    ref,
  ) => {
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            // This is a workaround to fix the side prop for the Sheet component.
            // TODO: fix this in the next version of Shadcn UI or when implementing ar localizations.
...
>(({ className, onClick: onClick, style: _style, ...props }, ref) => {
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-end-4 group-data-[side=right]:left-0 sm:flex',
